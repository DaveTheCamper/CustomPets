...
public class EntityHider implements Listener {
    ...
    private Set<Integer> hidded_all = new HashSet<>();
    
    public void hideForAllPlayers(Entity ent) {
    	for (Player p : Bukkit.getOnlinePlayers()) {
    		setVisibility(p, ent.getEntityId(), false);
    	}
    	hidded_all.add(ent.getEntityId());
    }
    ...
    private Listener constructBukkit() {
        return new Listener() {
            ...
            public void onPlayerJoinEvent(PlayerJoinEvent e) {
            	for (Integer i : hidded_all) {
            		setVisibility(e.getPlayer(), i, false);
            	}
            }
        };
    }
